  ...
  return (
    <section className='about-background'>
      <div className='about-container'>
        <h2 className='about-heading flicker-slowest neon-green'>
          About me  
        </h2>
        <div className='about-details'>
          <div className='about-description'>
            ...
            <p className='about-description-text'>
              ...
              Check out my projects and see how I'm going in my journey to becoming a full-fledged programmer. 

              <br /><br />
              <span className='about-text-ps'>PS: This is my first website, designing it really pushed my limits!</span>
            </p>
          </div>
